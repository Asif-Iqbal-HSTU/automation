...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request, $uid)
    {
        ...
        $name = $user->name;
        $studentID = $user->uid;
        $studentPhone = $user->mobile;
        $userStu = \App\Models\Student::find(session()->get('loginUser'))->first();
        $degree = $userStu->degree;
        $level = $userStu->currentLevel;
        $semester = $userStu->currentSemester;*/
